  ...
  const propsData = [
    {
      id:1,
      title: "About",
      body: "As a former polymer engineer turned software developer, I’ve embraced a new career path driven by my passion for building impactful, user-friendly solutions. My focus is now on creating intuitive, user-centric tools that streamline tasks and enhance everyday experiences. By combining my problem-solving mindset and technical skills, I aim to deliver valuable products while doing what I love."
    },
    {
      id:2,
      title: "Projects",
